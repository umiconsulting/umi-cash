...
export default function ScanPage() {
  ...
  function startQRDetection() {
    // BarcodeDetector is available in Chrome/Edge/Android but not Safari
  ...
  return (
    <div className="p-4 max-w-lg mx-auto">
      ...
      <div className="card-surface mb-4">
        ...
        {cameraError && (
          <p className="text-red-600 text-sm text-center mb-3">{cameraError}</p>
        )}

        <button
          onClick={scanning ? stopCamera : startCamera}
          className={scanning ? 'btn-secondary w-full' : 'btn-primary w-full'}
        >
      ...
      {/* Manual input */}
      <div className="card-surface mb-4">
        <p className="text-sm font-semibold text-coffee-dark mb-2">
      ...
      {result && (
        <div
          className={`card-surface border-2 animate-slide-up ${
            result.success
              ? result.rewardEarned
              ...
              <div className="mt-3 grid grid-cols-3 gap-2 text-xs">
                <div className="bg-white rounded-lg p-2 text-center">
                  <p className="font-bold text-coffee-dark">
                    {result.card.visitsThisCycle}/{result.card.visitsRequired}
                  </p>
