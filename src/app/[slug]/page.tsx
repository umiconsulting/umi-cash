    ...
    >
      ...
      <div className="text-white px-6 pt-14 pb-12" style={{ background: `linear-gradient(135deg, ${primary} 0%, ${primary}ee 100%)` }}>
        <div className="max-w-sm mx-auto relative z-10">
          ...
          <p className="text-white/40 text-xs mt-3">Disponible para iPhone y Android.</p>
        </div>
      </div>
      ...
      <section className="px-6 pb-12 max-w-sm mx-auto text-center">
        ...
        <p className="text-xs text-coffee-light/60 mt-1">Disponible para iPhone y Android.</p>
      </section>
